...
from ..types import Achievement, Item, UserID
...
class GameData(BaseData):
    ...
    async def get_settings(self, game: str, userid: UserID) -> Optional[ValidatedDict]:
        """
        ...
        cursor = await self.execute(sql, {'game': game, 'userid': userid})
    ...
    async def put_settings(self, game: str, userid: UserID, settings: Dict[str, Any]) -> None:
        """
        ...
        sql = (
                ...
                "ON CONFLICT(game, userid) DO UPDATE SET data=excluded.data"
        )
        await self.execute(sql, {'game': game, 'userid': userid, 'data': self.serialize(settings)})

    async def get_achievement(self, game: str, userid: UserID, achievementid: int, achievementtype: str) -> Optional[ValidatedDict]:
        """
        ...
        cursor = await self.execute(sql, {'game': game, 'userid': userid, 'id': achievementid, 'type': achievementtype})
    ...
    async def get_achievements(self, game: str, userid: UserID) -> List[Achievement]:
        """
    ...
    async def put_achievement(self, game: str, userid: UserID, achievementid: int, achievementtype: str, data: Dict[str, Any]) -> None:
        """
        ...
        sql = (
                ...
                "ON CONFLICT(game, userid, id, type) DO UPDATE SET data=excluded.data"
        )
        await self.execute(sql, {'game': game, 'userid': userid, 'id': achievementid, 'type': achievementtype, 'data': self.serialize(data)})

    async def get_time_sensitive_settings(self, game: str, version: int, name: str) -> Optional[ValidatedDict]:
        """
        ...
        cursor = await self.execute(sql, {'game': game, 'version': version, 'name': name, 'time': Time.now()})
    ...
    async def get_all_time_sensitive_settings(self, game: str, version: int, name: str) -> List[ValidatedDict]:
        """
        ...
        cursor = await self.execute(sql, {'game': game, 'version': version, 'name': name})
    ...
    async def put_time_sensitive_settings(self, game: str, version: int, name: str, settings: Dict[str, Any]) -> None:
        """
        ...
        sql = (
            ...
            "ON CONFLICT(game, version, name, start_time) DO UPDATE SET data=excluded.data"
        )
        await self.execute(
            sql,
            {
    ...
    async def get_item(self, game: str, version: int, catid: int, cattype: str) -> Optional[ValidatedDict]:
        """
        ...
        cursor = await self.execute(sql, {'game': game, 'version': version, 'id': catid, 'type': cattype})
    ...
    async def get_items(self, game: str, version: int) -> List[Item]:
        """
